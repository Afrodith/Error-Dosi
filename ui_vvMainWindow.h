...
public:
    ...
    void setupUi(QMainWindow *vvMainWindow)
    {
        ...
        NOViewWidget = new QVTKOpenGLNativeWidget(NOWidget);
        ...
        SOViewWidget = new QVTKOpenGLNativeWidget(SOWidget);
        ...
        NEViewWidget = new QVTKOpenGLNativeWidget(NEWidget);
        ...
        SEViewWidget = new QVTKOpenGLNativeWidget(SEWidget);
