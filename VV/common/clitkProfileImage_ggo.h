...
#ifndef CMDLINE_PARSER_CLITKPROFILEIMAGE_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_CLITKPROFILEIMAGE_PACKAGE_NAME "clitkProfileImage"
#endif
...
struct args_info_clitkProfileImage
{
  ...
  double* point1_arg;	/**< @brief First point (vox).  */
  char ** point1_orig;	/**< @brief First point (vox) original value given at command line.  */
  unsigned int point1_min; /**< @brief First point (vox)'s minimum occurreces */
  unsigned int point1_max; /**< @brief First point (vox)'s maximum occurreces */
  const char *point1_help; /**< @brief First point (vox) help description.  */
  double* point2_arg;	/**< @brief Second point (vox).  */
  char ** point2_orig;	/**< @brief Second point (vox) original value given at command line.  */
  unsigned int point2_min; /**< @brief Second point (vox)'s minimum occurreces */
  unsigned int point2_max; /**< @brief Second point (vox)'s maximum occurreces */
  const char *point2_help; /**< @brief Second point (vox) help description.  */
 ...
 */
int cmdline_parser_clitkProfileImage (int argc, char **argv,
 ...
 */
int cmdline_parser_clitkProfileImage2 (int argc, char **argv,
  struct args_info_clitkProfileImage *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkProfileImage_ext (int argc, char **argv,
  struct args_info_clitkProfileImage *args_info,
 ...
 */
int cmdline_parser_clitkProfileImage_configfile (const char *filename,
  struct args_info_clitkProfileImage *args_info,
  int override, int initialize, int check_required);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkProfileImage_config_file (const char *filename,
  struct args_info_clitkProfileImage *args_info,
  struct cmdline_parser_clitkProfileImage_params *params);
