...
#ifndef CMDLINE_PARSER_CLITKMIP_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_CLITKMIP_PACKAGE_NAME "clitkMIP"
#endif
...
struct args_info_clitkMIP
{
  ...
  int dimension_arg;	/**< @brief Dimension along which to project.  */
  char * dimension_orig;	/**< @brief Dimension along which to project original value given at command line.  */
  const char *dimension_help; /**< @brief Dimension along which to project help description.  */
 ...
 */
int cmdline_parser_clitkMIP (int argc, char **argv,
 ...
 */
int cmdline_parser_clitkMIP2 (int argc, char **argv,
  struct args_info_clitkMIP *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkMIP_ext (int argc, char **argv,
  struct args_info_clitkMIP *args_info,
 ...
 */
int cmdline_parser_clitkMIP_configfile (const char *filename,
  struct args_info_clitkMIP *args_info,
  int override, int initialize, int check_required);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkMIP_config_file (const char *filename,
  struct args_info_clitkMIP *args_info,
  struct cmdline_parser_clitkMIP_params *params);
