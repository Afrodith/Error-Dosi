...
#ifndef CMDLINE_PARSER_CLITKMEDIANIMAGEFILTER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_CLITKMEDIANIMAGEFILTER_PACKAGE_NAME "clitkMedianImageFilter"
#endif
...
struct args_info_clitkMedianImageFilter
{
  ...
  unsigned int radius_min; /**< @brief Radius in each Direction's minimum occurreces */
  unsigned int radius_max; /**< @brief Radius in each Direction's maximum occurreces */
 ...
 */
int cmdline_parser_clitkMedianImageFilter (int argc, char **argv,
 ...
 */
int cmdline_parser_clitkMedianImageFilter2 (int argc, char **argv,
  struct args_info_clitkMedianImageFilter *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkMedianImageFilter_ext (int argc, char **argv,
  struct args_info_clitkMedianImageFilter *args_info,
 ...
 */
int cmdline_parser_clitkMedianImageFilter_configfile (const char *filename,
  struct args_info_clitkMedianImageFilter *args_info,
  int override, int initialize, int check_required);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkMedianImageFilter_config_file (const char *filename,
  struct args_info_clitkMedianImageFilter *args_info,
  struct cmdline_parser_clitkMedianImageFilter_params *params);
