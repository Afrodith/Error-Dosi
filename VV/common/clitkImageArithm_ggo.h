...
#ifndef CMDLINE_PARSER_CLITKIMAGEARITHM_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_CLITKIMAGEARITHM_PACKAGE_NAME "clitkImageArithm"
#endif
 ...
 */
int cmdline_parser_clitkImageArithm (int argc, char **argv,
 ...
 */
int cmdline_parser_clitkImageArithm2 (int argc, char **argv,
  struct args_info_clitkImageArithm *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkImageArithm_ext (int argc, char **argv,
  struct args_info_clitkImageArithm *args_info,
 ...
 */
int cmdline_parser_clitkImageArithm_configfile (const char *filename,
  struct args_info_clitkImageArithm *args_info,
  int override, int initialize, int check_required);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkImageArithm_config_file (const char *filename,
  struct args_info_clitkImageArithm *args_info,
  struct cmdline_parser_clitkImageArithm_params *params);
