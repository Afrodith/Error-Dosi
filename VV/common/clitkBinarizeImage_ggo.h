...
#ifndef CMDLINE_PARSER_CLITKBINARIZEIMAGE_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_CLITKBINARIZEIMAGE_PACKAGE_NAME "clitkBinarizeImage"
#endif
...
struct args_info_clitkBinarizeImage
{
  ...
  double percentage_arg;	/**< @brief Percentage of total pixels values (in %).  */
  char * percentage_orig;	/**< @brief Percentage of total pixels values (in %) original value given at command line.  */
  const char *percentage_help; /**< @brief Percentage of total pixels values (in %) help description.  */
  ...
  unsigned int percentage_given ;	/**< @brief Whether percentage was given.  */
 ...
 */
int cmdline_parser_clitkBinarizeImage (int argc, char **argv,
 ...
 */
int cmdline_parser_clitkBinarizeImage2 (int argc, char **argv,
  struct args_info_clitkBinarizeImage *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkBinarizeImage_ext (int argc, char **argv,
  struct args_info_clitkBinarizeImage *args_info,
 ...
 */
int cmdline_parser_clitkBinarizeImage_configfile (const char *filename,
  struct args_info_clitkBinarizeImage *args_info,
  int override, int initialize, int check_required);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkBinarizeImage_config_file (const char *filename,
  struct args_info_clitkBinarizeImage *args_info,
  struct cmdline_parser_clitkBinarizeImage_params *params);
...
extern const char *cmdline_parser_clitkBinarizeImage_mode_values[];  /**< @brief Possible values for mode. */
