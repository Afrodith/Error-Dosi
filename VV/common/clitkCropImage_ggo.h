...
#ifndef CMDLINE_PARSER_CLITKCROPIMAGE_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_CLITKCROPIMAGE_PACKAGE_NAME "clitkCropImage"
#endif
...
struct args_info_clitkCropImage
{
  ...
  int* boundingBox_arg;	/**< @brief Bounding box of the crop region in pixel (in 3D: =x1,x2,y1,y2,z1,z2).  */
  char ** boundingBox_orig;	/**< @brief Bounding box of the crop region in pixel (in 3D: =x1,x2,y1,y2,z1,z2) original value given at command line.  */
  unsigned int boundingBox_min; /**< @brief Bounding box of the crop region in pixel (in 3D: =x1,x2,y1,y2,z1,z2)'s minimum occurreces */
  unsigned int boundingBox_max; /**< @brief Bounding box of the crop region in pixel (in 3D: =x1,x2,y1,y2,z1,z2)'s maximum occurreces */
  const char *boundingBox_help; /**< @brief Bounding box of the crop region in pixel (in 3D: =x1,x2,y1,y2,z1,z2) help description.  */
  ...
  unsigned int lower_min; /**< @brief Size of the lower crop region (multiple values)'s minimum occurreces */
  unsigned int lower_max; /**< @brief Size of the lower crop region (multiple values)'s maximum occurreces */
  ...
  unsigned int upper_min; /**< @brief Size of the upper crop region (multiple values)'s minimum occurreces */
  unsigned int upper_max; /**< @brief Size of the upper crop region (multiple values)'s maximum occurreces */
  ...
  int updateOrigin_flag;	/**< @brief By default, with like image, the output origin is the same than the like image. Set to on the flag to keep the origin. (default=off).  */
  const char *updateOrigin_help; /**< @brief By default, with like image, the output origin is the same than the like image. Set to on the flag to keep the origin. help description.  */
  ...
  unsigned int updateOrigin_given ;	/**< @brief Whether updateOrigin was given.  */
 ...
 */
int cmdline_parser_clitkCropImage (int argc, char **argv,
 ...
 */
int cmdline_parser_clitkCropImage2 (int argc, char **argv,
  struct args_info_clitkCropImage *args_info,
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkCropImage_ext (int argc, char **argv,
  struct args_info_clitkCropImage *args_info,
 ...
 */
int cmdline_parser_clitkCropImage_configfile (const char *filename,
  struct args_info_clitkCropImage *args_info,
  int override, int initialize, int check_required);
 ...
 * @return 0 if everything went fine, NON 0 if an error took place
 */
int cmdline_parser_clitkCropImage_config_file (const char *filename,
  struct args_info_clitkCropImage *args_info,
  struct cmdline_parser_clitkCropImage_params *params);
