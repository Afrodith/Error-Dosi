...
#include "vvSlicer.h"
#include <VV/vv/vvBlendImageActor.h>
...
//------------------------------------------------------------------------------
vvToolRigidReg::vvToolRigidReg(QWidget *parent, Qt::WindowFlags f)
{
  // GUI Initialization
  setupUi(this);
...
void vvToolRigidReg::SetTransform(vtkMatrix4x4 *matrix)
{
  ...
  transform->Update();
  Render();
 // dynamic_cast<NMDosimetry*>(mMainWindow)->ImageInfoChanged();
